...
class Abr():
    ...
    def abr(self, simstate, VIDEO_PROPERTIES, chunk_index):
        ...
        LEVELS_NO = VIDEO_PROPERTIES[chunk_index]["n_levels"] # number of levels(resolutions) in the chunk
        ...
        INDEXES = [] # list of levels indexes ex:(0-4)
        RESOLUTION_LIST = [] # list of resolutions in the chunk

        # create a list of indexes for each resolution in the current chunk 
